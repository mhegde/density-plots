...
if __name__ == '__main__':
    ...
    x = np.array(input_df.ix[:,args.col1])
    y = np.array(input_df.ix[:,args.col2])
    ...
    #ax.legend('upper right',frameon=False)
    ...
    fig.savefig(args.col1+'_'+args.col2+'_'+'density_plot.pdf')